...
main ()
{
 ...
 printf ("<html>\n");
 printf (" <head>\n");
 printf ("  <title>REQUEST REGISTRATION FORM</title>\n");
 printf (" </head>\n");
 printf (" <body>\n");
 printf ("  <nav>\n");
 ...
 printf ("  </footer>\n");
 printf ("    <form action=\"fsfRequestRegistration.cgi\" method=\"post\"> \n");
 printf ("      <fieldset>\n");
 printf ("       <legend>%s</legend>\n",FsfUmlGetWebUserInterfaceMessage(fsfUmlSignInMessage,fsfUmlLanguageId));
 printf ("       %s:<br>\n",FsfUmlGetWebUserInterfaceMessage(fsfUmlFriendEmailMessage,fsfUmlLanguageId));
 printf ("       <input type=\"text\" name=\"friendEmail\" maxlength=%i <br>\n",FSF_UML_EMAIL_MAX_LENGTH);
